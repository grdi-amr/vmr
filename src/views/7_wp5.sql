...
wgs.fast5_filename,                         wgs.genome_sequence_filename,                   wgs.r1_irida_id,
wgs.r2_irida_id,
-- Extra isolate fields
iso.organism,                               iso.microbiological_method,
...
iso.biosample_id,
-- Project fields
pro.project_name,                           pro.description,
pro.sample_plan_id,                         pro.sample_plan_name,
...
col.specimen_processing_details,            col.sample_collection_end_date,                 col.sample_processing_date,
col.sample_collection_start_time,           col.sample_collection_end_time,                 col.sample_collection_time_of_day,
col.sample_collection_time_duration_value,  col.sample_collection_time_duration_unit,
-- Geo fields
geo.country,                                geo.state_province_region,                      geo.latitude,
geo.longitude,                              geo.geo_loc_site,
-- Env fields
env.air_temperature,
...
hst.host_age_bin,                           hst.host_origin_geo_loc_name_country,
-- Food fields
fud.food_product_origin_country,
