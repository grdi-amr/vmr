...
col.sample_collector_contact_name,              
col.sample_collector_contact_email,
col.sample_collector_laboratory_name,       
col.sample_collection_date,                     
col.sample_collection_date_precision,
col.presamping_activity,                    
col.presampling_activity_details,               
col.purpose_of_samping,
...
env.available_data_types,
env.animal_or_plant_population,             
env.environmental_materials,                    
env.environmental_material_constituent,
env.environmental_sites,                    
env.sampling_weather_conditions,            
env.presampling_weather_conditions,             
env.precipitation_measurement_value,
env.precipitation_measurement_unit,         
env.precipitation_measurement_method,
-- Anatomical fields
ana.body_product,                           
ana.anatomical_material,                        
ana.anatomical_part,
ana.anatomical_region,
-- Host fields
hst.host_common_name,                       
hst.host_scientific_name,                       
hst.host_ecotype,
hst.host_breed,                             
...
fud.food_product_production_stream,         
fud.food_packaging_date,                        
fud.food_quality_date,
fud.label_claim,                            
fud.food_packaging,                             
fud.food_product,
fud.food_product_properties,                
fud.animal_source_of_food
FROM
wgs_wide AS wgs
